...
enum class GameFramework_EShakeParam : uint8_t
{
	ESP_OffsetRandom               = 0,
	ESP_OffsetZero                 = 1,
	ESP_MAX                        = 2,
...
enum class GameFramework_EConformType : uint8_t
{
	CFM_NavMesh                    = 0,
	CFM_BSP                        = 1,
	CFM_World                      = 2,
...
enum class GameFramework_ECrowdBehaviorEvent : uint8_t
{
	CBE_None                       = 0,
	CBE_Spawn                      = 1,
	CBE_Random                     = 2,
...
enum class GameFramework_ERecoilStart : uint8_t
{
	ERS_Zero                       = 0,
	ERS_Random                     = 1,
	ERS_MAX                        = 2,
...
enum class GameFramework_EGameSessionType : uint8_t
{
	GT_SessionInvalid              = 0,
	GT_SinglePlayer                = 1,
	GT_Coop                        = 2,
...
enum class GameFramework_ECameraViewportTypes : uint8_t
{
	CVT_16to9_Full                 = 0,
...
enum class GameFramework_EZoneType : uint8_t
{
	ZoneType_Button                = 0,
	ZoneType_Joystick              = 1,
...
enum class GameFramework_EZoneState : uint8_t
{
...
enum class GameFramework_EZoneSlideType : uint8_t
{
	ZoneSlide_UpDown               = 0,
...
enum class GameFramework_EUIOrientation : uint8_t
{
	UI_Unknown                     = 0,
	UI_Portait                     = 1,
...
enum class GameFramework_EMenuImageDrawStyle : uint8_t
{
	IDS_Normal                     = 0,
	IDS_Stretched                  = 1,
	IDS_Tile                       = 2,
...
enum class GameFramework_ETextDrawMethod : uint8_t
{
	DRAW_CenterText                = 0,
	DRAW_WrapText                  = 1,
	DRAW_MAX                       = 2,
...
struct FRequiredMobileInputConfig
{
	...
	unsigned long                                      bIsAttractModeGroup : 1;                                   // 0x0020(0x0001) BIT_FIELD (Config)
...
struct FBehaviorEntry
{
	...
	unsigned long                                      bNeverRepeat : 1;                                          // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bHasBeenUsed : 1;                                          // 0x0014(0x0001) BIT_FIELD
	unsigned long                                      bCanBeUsed : 1;                                            // 0x0014(0x0001) BIT_FIELD
...
struct FAvoidOtherSampleItem
{
	...
	unsigned char                                      UnknownData_HQ0I[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned long                                      bFallbackOnly : 1;                                         // 0x0008(0x0001) BIT_FIELD (Edit)
...
{
	TEnumAsByte<Engine_ETouchType>                     EventType;                                                 // 0x0000(0x0001)
	unsigned char                                      TouchpadIndex;                                             // 0x0001(0x0001)
	unsigned char                                      UnknownData_WSFU[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTouchData
{
	...
	unsigned char                                      UnknownData_H15P[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned long                                      bInUse : 1;                                                // 0x002C(0x0001) BIT_FIELD
	class UMobileInputZone*                            Zone;                                                      // 0x0030(0x0008)
	TEnumAsByte<Engine_ETouchType>                     State;                                                     // 0x0038(0x0001)
	unsigned char                                      UnknownData_283U[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCrowdSpawnInfoItem
{
	...
	unsigned long                                      bSpawningActive : 1;                                       // 0x0008(0x0001) BIT_FIELD
	...
	unsigned long                                      bForceObstacleChecking : 1;                                // 0x0050(0x0001) BIT_FIELD
	unsigned long                                      bForceNavMeshPathing : 1;                                  // 0x0050(0x0001) BIT_FIELD
	unsigned long                                      bEnableCrowdLightEnvironment : 1;                          // 0x0050(0x0001) BIT_FIELD
	unsigned long                                      bCastShadows : 1;                                          // 0x0050(0x0001) BIT_FIELD
...
struct FUVCoords
{
	unsigned long                                      bCustomCoords : 1;                                         // 0x0000(0x0001) BIT_FIELD (Edit)
...
struct FPropertyInfo
{
	...
	unsigned long                                      bModifyProperty : 1;                                       // 0x0008(0x0001) BIT_FIELD (Edit)
...
{
	TEnumAsByte<GameFramework_ERecoilStart>            X;                                                         // 0x0000(0x0001) (Edit)
	TEnumAsByte<GameFramework_ERecoilStart>            Y;                                                         // 0x0001(0x0001) (Edit)
	TEnumAsByte<GameFramework_ERecoilStart>            Z;                                                         // 0x0002(0x0001) (Edit)
...
struct FCamFocusPointParams
{
	...
	unsigned long                                      bAlwaysFocus : 1;                                          // 0x0030(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bAdjustCamera : 1;                                         // 0x0030(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bIgnoreTrace : 1;                                          // 0x0030(0x0001) BIT_FIELD (Edit)
...
struct FTakeHitInfo
{
	...
	unsigned char                                      UnknownData_XTM6[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FShakeParams
{
	TEnumAsByte<GameFramework_EShakeParam>             X;                                                         // 0x0000(0x0001)
	TEnumAsByte<GameFramework_EShakeParam>             Y;                                                         // 0x0001(0x0001)
	TEnumAsByte<GameFramework_EShakeParam>             Z;                                                         // 0x0002(0x0001)
	unsigned char                                      Padding;                                                   // 0x0003(0x0001) (Const, Transient)
...
struct FScreenShakeStruct
{
	...
	TEnumAsByte<GameFramework_EShakeParam>             FOVParam;                                                  // 0x0064(0x0001)
	unsigned char                                      UnknownData_MYHU[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       ShakeName;                                                 // 0x0068(0x0008)
	unsigned long                                      bOverrideTargetingDampening : 1;                           // 0x0070(0x0001) BIT_FIELD
...
struct FScreenShakeAnimStruct
{
	...
	unsigned long                                      bUseDirectionalAnimVariants : 1;                           // 0x0008(0x0001) BIT_FIELD
	...
	unsigned long                                      bRandomSegment : 1;                                        // 0x0034(0x0001) BIT_FIELD
	float                                              RandomSegmentDuration;                                     // 0x0038(0x0004)
	unsigned long                                      bSingleInstance : 1;                                       // 0x003C(0x0001) BIT_FIELD
...
{
	unsigned long                                      bIsDragging : 1;                                           // 0x0000(0x0001) BIT_FIELD
	int                                                IndexFrom;                                                 // 0x0004(0x0004)
	unsigned long                                      bIsOver : 1;                                               // 0x0008(0x0001) BIT_FIELD
	int                                                IndexOver;                                                 // 0x000C(0x0004)
	unsigned long                                      bCanDropInOver : 1;                                        // 0x0010(0x0001) BIT_FIELD
	struct FVector2D                                   OrigTouch;                                                 // 0x0014(0x0008)
	struct FVector2D                                   CurTouch;                                                  // 0x001C(0x0008)
	TEnumAsByte<Engine_ETouchType>                     EventType;                                                 // 0x0024(0x0001)
...
{
	unsigned long                                      bIsDragItem : 1;                                           // 0x0000(0x0001) BIT_FIELD
...
struct FSelectedMenuItem
{
	...
	unsigned long                                      bEndOfList : 1;                                            // 0x0008(0x0001) BIT_FIELD
...
{
	unsigned long                                      bIsMoving : 1;                                             // 0x0000(0x0001) BIT_FIELD
...
struct FMenuListDragInfo
{
	...
	struct FDragHistoryData                            UpdateHistory[0x4];                                        // 0x002C(0x0020)
	int                                                NumUpdates;                                                // 0x004C(0x0004)
	unsigned long                                      bHasSelectedChanged : 1;                                   // 0x0050(0x0001) BIT_FIELD
