...
enum class Core_EFColNavMeshOption : uint8_t
{
	EFCNMO_INCLUDE                 = 0,
	EFCNMO_EXCLUDE                 = 1,
	EFCNMO_MAX                     = 2,
...
enum class Core_EFColProjectileOption : uint8_t
{
	EFCPO_ENABLE                   = 0,
	EFCPO_PENETRATE                = 1,
	EFCPO_MAX                      = 2,
...
enum class Core_EFColMoveColOption : uint8_t
{
	EFCMCO_ENABLE                  = 0,
	EFCMCO_PENETRATE               = 1,
	EFCMCO_MAX                     = 2,
...
enum class Core_EFColMovePickingOption : uint8_t
{
	EFCMPO_ENABLE                  = 0,
	EFCMPO_PENETRATE               = 1,
	EFCMPO_WALL                    = 2,
...
enum class Core_ELocObjectLanguageExtension : uint8_t
{
...
enum class Core_ELocObjectLanguageSubExtension : uint8_t
{
...
struct FInterpCurvePointVector2D
{
	...
	TEnumAsByte<Core_EInterpCurveMode>                 InterpMode;                                                // 0x001C(0x0001) (Edit)
...
struct FInterpCurvePointFloat
{
	...
	TEnumAsByte<Core_EInterpCurveMode>                 InterpMode;                                                // 0x0010(0x0001) (Edit)
...
struct FPointer
{
	...
	unsigned char                                      UnknownData_R9SG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KMQ0[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FInterpCurvePointLinearColor
{
	...
	TEnumAsByte<Core_EInterpCurveMode>                 InterpMode;                                                // 0x0034(0x0001) (Edit)
...
{
	float                                              InVal;                                                     // 0x0000(0x0004) (Edit)
	unsigned char                                      UnknownData_4XJ6[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpCurvePointVector
{
	...
	TEnumAsByte<Core_EInterpCurveMode>                 InterpMode;                                                // 0x0028(0x0001) (Edit)
...
struct FInterpCurvePointTwoVectors
{
	...
	TEnumAsByte<Core_EInterpCurveMode>                 InterpMode;                                                // 0x004C(0x0001) (Edit)
...
struct FMatineeRawDistributionFloat : public FRawDistributionFloat
{
	...
	unsigned long                                      bInMatinee : 1;                                            // 0x0028(0x0001) BIT_FIELD
