...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxEngine");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxFSCmdHandler");
		return ptr;
	}
...
// 0x000C (FullSize[0x00AC] - InheritedSize[0x00A0])
...
public:
	...
	unsigned long                                      bFakeMobileTouches : 1;                                    // 0x00A8(0x0001) BIT_FIELD


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxInteraction");
		return ptr;
	}
...
// 0x01DC (FullSize[0x022C] - InheritedSize[0x0050])
...
public:
	...
	unsigned char                                      ASUClasses[0x48];                                          // 0x0068(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUClasses
	unsigned char                                      ASUObjects[0x48];                                          // 0x00B0(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUObjects
	int                                                NextASUObject;                                             // 0x00F8(0x0004) (Const, Transient)
	class USwfMovie*                                   MovieInfo;                                                 // 0x00FC(0x0008)
	unsigned long                                      bMovieIsOpen : 1;                                          // 0x0104(0x0001) BIT_FIELD (Const)
	unsigned long                                      bDisplayWithHudOff : 1;                                    // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bEnableGammaCorrection : 1;                                // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bWidgetsInitializedThisFrame : 1;                          // 0x0104(0x0001) BIT_FIELD (Const, Transient)
	unsigned long                                      bLogUnhandedWidgetInitializations : 1;                     // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bAllowInput : 1;                                           // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bAllowFocus : 1;                                           // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bAutoPlay : 1;                                             // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bPauseGameWhileActive : 1;                                 // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bDisableWorldRendering : 1;                                // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bCaptureWorldRendering : 1;                                // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bCloseOnLevelChange : 1;                                   // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bOnlyOwnerFocusable : 1;                                   // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bForceFullViewport : 1;                                    // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bDiscardNonOwnerInput : 1;                                 // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bCaptureInput : 1;                                         // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bCaptureMouseInput : 1;                                    // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bIgnoreMouseInput : 1;                                     // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bIsSplitscreenLayoutModified : 1;                          // 0x0104(0x0001) BIT_FIELD (Transient)
	unsigned long                                      bShowHardwareMouseCursor : 1;                              // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bBlurLesserMovies : 1;                                     // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bHideLesserMovies : 1;                                     // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bIsPriorityBlurred : 1;                                    // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bIsPriorityHidden : 1;                                     // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bIgnoreVisibilityEffect : 1;                               // 0x0104(0x0001) BIT_FIELD
	unsigned long                                      bIgnoreBlurEffect : 1;                                     // 0x0104(0x0001) BIT_FIELD
	...
	TEnumAsByte<GFxUI_EGFxTimingMode>                  TimingMode;                                                // 0x015C(0x0001)
	TEnumAsByte<GFxUI_EGFxRenderTextureMode>           RenderTextureMode;                                         // 0x015D(0x0001)
	unsigned char                                      Priority;                                                  // 0x015E(0x0001)
	unsigned char                                      UnknownData_KG9B[0x1];                                     // 0x015F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FGFxWidgetBinding>                   WidgetBindings;                                            // 0x0160(0x0010) (NeedCtorLink)
	unsigned char                                      WidgetBindingMaps[0x48];                                   // 0x0170(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetBindingMaps
	unsigned char                                      WidgetPathBindings[0x48];                                  // 0x01B8(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	...
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                 // 0x021C(0x000C) ELEMENT_SIZE_MISMATCH (NeedCtorLink)
	unsigned char                                      UnknownData_OJ7W[0x4];                                     // 0x021C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxMoviePlayer");
		return ptr;
	}
...
// 0x009C (FullSize[0x00EC] - InheritedSize[0x0050])
class UGFxObject : public UObject
{
public:
	int                                                Value[0xC];                                                // 0x0050(0x0030) (Const, Native)
	...
	unsigned char                                      SubWidgetBindingMaps[0x48];                                // 0x00A0(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxObject.SubWidgetBindingMaps
	unsigned long                                      bListenExternalInterfaceCall : 1;                          // 0x00E8(0x0001) BIT_FIELD


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxObject");
		return ptr;
	}
...
// 0x0010 (FullSize[0x00FC] - InheritedSize[0x00EC])
class UGFxClikWidget : public UGFxObject
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                                 // 0x00EC(0x000C) ELEMENT_SIZE_MISMATCH (NeedCtorLink)
	unsigned char                                      UnknownData_GCL3[0x4];                                     // 0x00EC(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxClikWidget");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxRawData");
		return ptr;
	}
...
// 0x004C (FullSize[0x00DC] - InheritedSize[0x0090])
class USwfMovie : public UGFxRawData
{
public:
	unsigned long                                      bUsesFontlib : 1;                                          // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bSetSRGBOnImportedTextures : 1;                            // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned long                                      bPackTextures : 1;                                         // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bForceSquarePacking : 1;                                   // 0x0090(0x0001) BIT_FIELD (Edit)
	struct FString                                     SourceFile;                                                // 0x0094(0x0010) (Edit, NeedCtorLink, EditorOnly)
	int                                                PackTextureSize;                                           // 0x00A4(0x0004) (Edit)
	TEnumAsByte<GFxUI_EFlashTextureRescale>            TextureRescale;                                            // 0x00A8(0x0001) (Edit)
	unsigned char                                      UnknownData_9V26[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.SwfMovie");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.FlashMovie");
		return ptr;
	}
...
public:
	...
	unsigned long                                      bUnload : 1;                                               // 0x0158(0x0001) BIT_FIELD (Edit)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxAction_CloseMovie");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxAction_GetVariable");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxAction_Invoke");
		return ptr;
	}
...
public:
	...
	unsigned long                                      bTakeFocus : 1;                                            // 0x0168(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bCaptureInput : 1;                                         // 0x0168(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bStartPaused : 1;                                          // 0x0168(0x0001) BIT_FIELD (Edit)
	unsigned long                                      bEnableGammaCorrection : 1;                                // 0x0168(0x0001) BIT_FIELD
	unsigned long                                      bDisplayWithHudOff : 1;                                    // 0x0168(0x0001) BIT_FIELD (Edit)
	TEnumAsByte<GFxUI_EGFxRenderTextureMode>           RenderTextureMode;                                         // 0x016C(0x0001) (Edit)
	unsigned char                                      UnknownData_MZZU[0x3];                                     // 0x016D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxAction_OpenMovie");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxAction_SetCaptureKeys");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxAction_SetVariable");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxEvent_FSCommand");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GFxUI.GFxFSCmdHandler_Kismet");
		return ptr;
	}
